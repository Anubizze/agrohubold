...
urlpatterns = [
    ...
    path('projects/collaboration/', views.project_collaboration_request, name='project_collaboration_request'),
    path('projects/proposal/', views.project_proposal_request, name='project_proposal_request'),
